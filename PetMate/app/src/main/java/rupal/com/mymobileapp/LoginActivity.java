...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    TextView createAccTxt;//rupal
    Button loginBtn;//rupal
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createAccTxt = (TextView) findViewById(R.id.createAccTxt);//rupal
        loginBtn = (Button) findViewById(R.id.loginBtn);//rupal
